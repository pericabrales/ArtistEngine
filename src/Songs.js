...
import {getSongsFromArtist, getToken} from './selectors/selector';
...
                const req = new Request(`https://api.spotify.com/v1/artists/${query}/top-tracks?market=US`, {
                    headers: new Headers({
...
                    console.log("res items: ", res.atists.items[0]);
...
                var artistId = jsResponse.uri.substring(1).split(":");
